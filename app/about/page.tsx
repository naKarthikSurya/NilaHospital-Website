...
export const metadata: Metadata = {
  ...
  description: "The story of Nila Hospital — committed to providing sterile, safe, and women-focused maternity healthcare in Namakkal. Dedicated to clinical excellence and personal attention since inception.",
  alternates: {
    canonical: "/about",
  },
};
      ...
      <section className="nila-gradient nila-gradient-motion text-white py-20 relative overflow-hidden">
        ...
        <div className="container max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-4">
            Women's Specialist Hospital<br />in Namakkal
          </h1>
              ...
              <div className="relative bg-card border border-border shadow-2xl rounded-[2.5rem] overflow-hidden p-8 md:p-12">
                <div className="flex flex-col items-center text-center space-y-6">
                  <div className="w-32 h-32 rounded-full bg-muted flex items-center justify-center overflow-hidden border-4 border-[hsl(var(--nila-warm-light))] shadow-lg">
                    <img src="/assets/NHLogo_NB.svg" alt="Dr. Nithya Subashini" className="w-full h-full object-cover" />
                  </div>
                  <div>
